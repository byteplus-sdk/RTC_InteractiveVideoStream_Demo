 ...
 * @notes After the user calls stopScreenCapture{@link #ByteRTCEngineKit#stopScreenCapture}, this method will be triggered to notify the SDK on the Extension side to stop the screen capture.
 */
- (void)onQuitFromApp;
/** 
 * @type api
