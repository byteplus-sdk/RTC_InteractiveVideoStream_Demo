...
- (BaseButton *)onlineButton {
    if (!_onlineButton) {
        ...
        [_onlineButton setTitle:LocalizedString(@"Audience") forState:UIControlStateNormal];
...
- (BaseButton *)appleButton {
    if (!_appleButton) {
        ...
        [_appleButton setTitle:LocalizedString(@"Guest requests") forState:UIControlStateNormal];
