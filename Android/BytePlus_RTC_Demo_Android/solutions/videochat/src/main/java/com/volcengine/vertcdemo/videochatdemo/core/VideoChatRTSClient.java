...
public class VideoChatRTSClient extends RTSBaseClient {
    ...
    public VideoChatRTSClient(RTCVideo video, RTSInfo rtmInfo) {
        super(video, rtmInfo);
    }
    ...
    public void manageInteractApply(String roomId, int type, IRequestCallback<RTSBizResponse> callback) {
    ...
    public void requestFinishLive(String roomId, IRequestCallback<RTSBizResponse> callback) {
    ...
    public void finishInteract(String roomId, int seatId, IRequestCallback<RTSBizResponse> callback) {
    ...
    public void requestLeaveRoom(String roomId, IRequestCallback<RTSBizResponse> callback) {
    ...
    public void sendMessage(String roomId, String message, IRequestCallback<RTSBizResponse> callback) {
    ...
    public void requestClearUser(IRequestCallback<RTSBizResponse> callback) {
        JsonObject params = getCommonParams(CMD_CLEAR_USER);
        sendServerMessageOnNetwork("", params, RTSBizResponse.class, callback);
    }
    ...
    public void finishAnchorInteract(String roomId, IRequestCallback<RTSBizResponse> callback) {
    ...
    public void closeChatRoom(String roomId, String userId, IRequestCallback<RTSBizResponse> callback) {
